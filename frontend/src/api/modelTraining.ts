  ...
  return [
    {
      ...
      displayName: 'Deepexi Factory Copilot SFT',
    ...
    },
    {
      ...
      trainMethod: 'qlora',
      baseModel: 'Deepexi-VL-Industry-32B',
    ...
    },
    {
      ...
      displayName: 'Deepexi Doc Parser LoRA',
      ...
      trainMethod: 'lora',
      baseModel: 'Deepexi-VL-Document-7B',
...
export async function startTraining(projectKey: string): Promise<TrainingJob> {
  ...
  const newJob: TrainingJob = {
    ...
    datasetName: project?.datasetName ?? '',
    baseModel: project?.baseModel ?? 'Deepexi-R1-Industry-32B',
...
export async function createTrainingProject(input: {
  ...
  const project: TrainingProject = {
    ...
    baseModel: input.baseModel ?? 'Deepexi-R1-Industry-32B',
